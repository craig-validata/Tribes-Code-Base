...
setPlayChatMenu("tTarget");
		...
		addPlayTeamChat("lTarget location", "Where is it?", tgtobj);
...
setPlayChatMenu("eTeam");
		...
		addPlayTeamChat("pProceed", "Get your slow ass moving", goway);
...
setPlayChatMenu("gGlobal");
		...
		addPlayChat("ySorry", "Please forgive me...", sorry);
...
//		addPlayAnim("zKneel Pose", 10);
		addPlayAnim("xStand Pose", 11, dsgst2);
		...
		addPlayAnim("mMove out", 4, moveout);
