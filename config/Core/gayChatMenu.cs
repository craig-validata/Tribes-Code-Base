...
setPlayChatMenu("vOffense");
		...
		addPlayTeamChat("hHit deck", "OMG Hit the deck!", hitdeck);
		addPlayTeamChat("eRegroup", "Regroup.", regroup);
		addPlayTeamChat("vCover me", "Cover me!", coverme);
		addPlayTeamChat("gGoing offense", "I will attack them", ono);
		addPlayTeamChat("zAPC ready", "APC ready to go... waiting for passengers.", waitpas);
		addPlayTeamChat("tTake Cover!", "Quick hide!!!", takcovr);
		addPlayTeamChat(" Attack!!!", "ATTACK!!!!", attac2);
		addPlayTeamChat("sAttack enemy base", "All their base are belonging to us!!", attbase);
		addPlayTeamChat("xAttack enemy", "Fight them...", attenem);
...
setPlayChatMenu("tTarget");
		...
		addPlayTeamChat("sEnemy Turret Destroyed", "Enemy turret destroyed. You're welcome", turdes);
...
setPlayChatMenu("dDefense");
		...
		addPlayTeamChat("hHelp!", "Please I beg you!!", isbsclr);
...
setPlayChatMenu("eTeam");
		...
		addPlayTeamChat("sSorry", "Please forgive me...", sorry);
...
setPlayChatMenu("gGlobal");
		...
		addPlayChat("sShazbot", "Shazbot all over my face!", color2);
		addPlayChat("qDamnit", "Damnit!", color6);
		addPlayChat("cCrap", "Ah Crap! Im so gay", color7);
		addPlayChat("eDuh", "Duh I love the boys.", dsgst1);
		addPlayChat("xYou Idiot", "You Idiot! Just kidding I think ur cute", dsgst2);
		addPlayChat("gI've Had Worse", "I've had some big cock.", tautn11);
		addPlayChat("hHi", "Hi boys!! HMU.", hello);
		addPlayChat("bBye", "Bye boys! Love you long time", bye);
		addPlayChat("ySorry", "Please forgive me... I'm LGBTQ", sorry);
		addPlayChat("dI don't know", "I don't know.. I cant stop thinking about you", dontkno);
		addPlayChat("wArgh!", "Argh! Im so gay", dsgst4);
		addPlayChat("kHmmmm...", "Hmmm... I like the D", color3);
		addPlayChat("mYooo-Hooo!", "So gay!", taunt1);
		addPlayChat("uWhoohoo", "Im so gay!", cheer2);
		addPlayChat("iYeah!", "Yeah! Happy Pride Month!", cheer1);
		addPlayChat("jAlright!", "Alright! Capping the flag is just a social construct", cheer3);
		addPlayChat("pWait", "Wait.. I'm gay", wait1);
		addPlayChat("aNo Problem", "Give me a kiss", noprob);
		addPlayChat("tThanks", "Thanks.. I want your number", thanks);
		...
		addPlayChat("6Sigh", "*sigh* I love the men", dsgst5);
		addPlayChat("7Yes", "Yes!!", yes);
		addPlayChat("8No", "No!!", no);
		addPlayChat("fReturn our flag", "Give it back!!", retflag);
		addPlayChat("-Felt good", "That felt good", deathv);
...
//		addPlayAnim("zKneel Pose", 10);
		...
		addPlayAnim("tCelebrate 3", 7, cheer3);
		...
		addPlayAnim("wHurry", 11, hurystn);
		addPlayAnim(" Death Scream", 8, death);
		addPlayAnim("aPilot APC", 0, pilot);
		addPlayAnim("zHelp", 10, help);
		addPlayAnim("nUnable to complete", 4, objxcmp);
