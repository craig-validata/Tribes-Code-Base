...
function CtfHUD::Init() {
	...
	HUD::New("CtfHUD::Container", 500, 8, 200, 49, CtfHUD::Wake, CtfHUD::Sleep);
	newObject("CtfHUD::Image0", FearGuiFormattedText, 0, 0, 23, 20); 
	newObject("CtfHUD::Image1", FearGuiFormattedText, 0, 22, 23, 20);

	newObject("CtfHUD::Status0", FearGuiFormattedText, 35, 3, 150, 20); 
	newObject("CtfHUD::Status1", FearGuiFormattedText, 35, 25, 150, 20);
