...
bindCommand(keyboard0, make, "f10", TO, "AutoBuy::SelectAndBuyLoadout(10);");
bindCommand(keyboard0, make, "f11", TO, "AutoBuy::SelectAndBuyLoadout(11);");
bindCommand(keyboard0, make, "f12", TO, "AutoBuy::SelectAndBuyLoadout(12);");
bindCommand(keyboard0, make, "-", TO, "Colorchange::styleup();");
bindCommand(keyboard0, make, "lshift", TO, "StatHUD::Show();");
bindCommand(keyboard0, break, "lshift", TO, "StatHUD::Hide();");
...
bindCommand(keyboard0, make, l_control, "r", TO, "drop(BackPack);");
bindCommand(mouse0, make, button1, TO, "Plas::Jet();");
bindCommand(mouse0, break, button1, TO, "Plas::EndJet();");
bindCommand(keyboard0, make, "q", TO, "nextWeapon();");
bindCommand(keyboard0, make, "f", TO, "use(\"BackPack\");");
...
bindCommand(mouse0, make, button2, TO, "kill();");
bindAction(mouse0, make, button0, TO, IDACTION_FIRE1);
bindAction(mouse0, break, button0, TO, IDACTION_BREAK1);
bindAction(mouse0, xaxis0, TO, IDACTION_YAW, Flip, Scale, 0.001213);
bindAction(mouse0, yaxis0, TO, IDACTION_PITCH, Flip, Scale, 0.001213);
